...
export default function NewsLetter() {
  return (
    <section className="flex gap-2 pt-16 pb-10 items-stretch flex-col xl:flex-row">
        ...
        <div className="border border-neutral-300 rounded-xl px-5 py-14 group transition-colors duration-500 hover:border-black">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:items-center mb-6 w-full">
            <input
              ...
              className="rounded-full px-8 py-3 sm:mb-0 mb-2 border border-neutral-500 w-full"
            />
            <Link href="">
              <span className="block py-3 sm:py-4 px-0 sm:px-12 text-lg w-full sm:w-auto text-center rounded-full font-bold bg-black text-white">
                Subscribe
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-start gap-2">
            ...
            <span className="text-neutral-500 text-sm">
              ...
              agreed to our Terms and Conditions also the Privacy Policy,
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full xl:w-[60%] flex flex-col xl:flex-row gap-2">
        <div className="flex flex-col gap-2 w-full xl:w-1/2">
            ...
            <a href="" className="flex-1">
              <div className="rounded-xl overflow-hidden">
                <img
                  ...
                  alt=""
                  className="w-full  object-cover transition-transform duration-500 ease-in-out hover:scale-110 hover:rotate-3"
                />
              </div>
            </a>
            <a href="" className="flex-1">
          ...
          <div className="border border-neutral-300 rounded-sm h-full px-5 py-8 group transition-colors duration-500 hover:border-black flex flex-col justify-between ">
            <p>
        ...
        <div className="flex flex-col sm:flex-row xl:flex-row gap-2 w-full xl:w-1/2">
