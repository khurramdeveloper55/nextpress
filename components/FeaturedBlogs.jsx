      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-6 text-white z-10">
            ...
            <h2 className="text-2xl sm:text-[40px] font-bold mt-4 leading-snug break-words">
              Post-modernist Apartment Design That Combines Bold Colors, Art,
              and Geometric Shapes
            </h2>
            <hr className="my-4 border-white/60" />
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-2 mb-4 gap-2 sm:gap-0">
              <div>
        ...
        <div className="w-full md:w-1/3 flex flex-col gap-4">
          <div className="hover-image-3 border border-neutral-300 rounded-sm px-5 py-6 group transition-colors duration-500">
            ...
            <h2 className="font-bold my-6 group/heading leading-snug text-lg sm:text-base">
              <a
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-6 mb-8 gap-2 sm:gap-0">
              <div>
